...
const Home = () => {
  const [articles, setArticles] = useState<Array<Stripe.Product>>([]);
  const { setStripeProducts } = useGlobals();
  ...
  return (
    <main>
      <section className={styles.section}>
        <div className={styles.hero}>
          ...
          <div className={styles.description}>
            <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit nam nemo culpa minus veritatis omnis. Placeat tempora obcaecati tenetur porro vero iusto rerum dolore nulla?</h2>
          </div>
      ...
      <section id="about" className={`${styles.section} ${styles.inline}`}>
        ...
        <div className={styles.about}>
          <div className={styles.wrapper}>
            <h3>Chi siamo</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam, ea architecto aut atque repellat ullam. Molestias hic iusto sint impedit, necessitatibus ratione doloribus quos officia earum labore totam consequatur alias.</p>
            <br />
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam, ea architecto aut atque repellat ullam. Molestias hic iusto sint impedit, necessitatibus ratione doloribus quos officia earum labore totam consequatur alias.</p>
            <button></button>
          </div>
